...
export default class LoggerService implements Logger {
  ...
  public constructor(
    ...
    this.organization = configService.get<string>('ORGANIZATION') as string;
    this.context = configService.get<string>('CONTEXT') as string;
    this.app = configService.get<string>('APP') as string;
  }
